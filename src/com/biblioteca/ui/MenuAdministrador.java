...
import com.biblioteca.GestionProductos.AgregarFormulario;
import com.biblioteca.GestionProductos.EditarFormulario;
...
import com.biblioteca.Administracion.GenerarReportesPanel;
import com.biblioteca.Administracion.EditarEliminarRegistrosPanel;
...
//}
    ...
    private JPanel crearSubMenuGestionUsuarios() {
        ...
        agregarUsuario.addActionListener(e -> mostrarContenido(new AgregarUsuario())); // Reemplaza con el panel adecuado
